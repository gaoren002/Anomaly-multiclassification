...
class GeneratedMVTecDataset(torch.utils.data.Dataset):
    """
    ...
    def get_image_data(self):
        ...
        for classname in self.classnames_to_use:
            ...
            ori_imgs = sorted(glob.glob(ori_img_classpath+"/*.png"))
...
class GeneratedMVTecDatasetForRelationNet(torch.utils.data.Dataset):
    """
    PyTorch Dataset for MVTec.
    """
